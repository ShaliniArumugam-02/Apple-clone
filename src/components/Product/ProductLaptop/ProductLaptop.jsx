  ...
  return (
    ...
    <div className="  hidden lg:grid grid-cols-2 gap-3 ">
        <section className="w-full h-auto relative ">
          ...
          <div className="absolute mt-5 inset-0 text-white flex flex-col items-center gap-7">
            <h1 className="text-6xl font-bold">iPad Pro</h1>
            <p className="text-3xl font-semibold">
              Unbelievably thin. Incredibly Powerful.
            </p>
            <div className="flex gap-3">
              <CustomButton text= "Learn more" variant="primary" textSize="text-xl"/>
              <CustomButton text="Buy" variant="dark" textSize='text-xl'/>
        ...
        <section className="w-full h-auto relative">
          ...
          <div className="absolute inset-0 mt-5 text-black flex flex-col items-center  gap-7">
            ...
            <div className="flex gap-3">
              <CustomButton text= "Learn more" variant="primary" textSize='text-xl'/>
              <CustomButton text="Buy" variant="secondary"textSize='text-xl' />
            </div>
          </div>
        </section>
        <section className="relative w-full h-auto mt-5">
          <img src={macMedium} alt="macstudent" className="w-full h-[500px]"
          />
        ...
        <section className="relative w-full h-auto mt-5">
          ...
          <div className="absolute  inset-0 top-1/2 text-white flex flex-col items-center justify-center gap-7">
            <h1 className="text-6xl font-bold">Airpods 4</h1>
            <p className="text-3xl font-semibold">Iconic. Now supersonic</p>
              <div className="flex gap-3">
        ...
        <section className="w-full h-auto relative mt-5">
          ...
          <div className="absolute mt-10 inset-0 text-black flex flex-col items-center  gap-10">
            <div className="flex items-center gap-2 text-6xl font-bold">
              <FaApple />
              <span>Trade In</span>
            </div>
